...
State::State(std::string name, CallbackFunction on_enter, CallbackFunction on_state, CallbackFunction on_exit, bool is_final /* = false */) {
  setup(name, on_enter, on_state, on_exit, is_final);
}

/////////////////////////////////////////////////////////////////

void State::setup(std::string name, CallbackFunction on_enter, CallbackFunction on_state, CallbackFunction on_exit, bool is_final /* = false */) {
  this->name = name;
