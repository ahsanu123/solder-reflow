...
protected:
  ...
  std::string dot_definition = "";

  bool _isDuplicate(const TimedTransition &transition,
                    const TimedTransition *transitionArray,
                    int arraySize) const;
  bool _isDuplicate(const Transition &transition,
                    const Transition *transitionArray, int arraySize) const;
  ...
  std::string _dot_transition(std::string from, std::string to,
                              std::string label, std::string param);
  std::string _dot_inital_state();
  std::string _dot_header();
  std::string _dot_active_node();
};
