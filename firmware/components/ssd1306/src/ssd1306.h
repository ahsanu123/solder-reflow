...
public:
   ...
   * @param   force   The program automatically tracks "dirty" region to
   * minimize refresh area. Set #force to true ignores the dirty region and
  ...
  void invert_display(bool invert); /**
                                     ...
                                     * @param   data        Data to fill display
                                     * buffer, no length check is performed!
