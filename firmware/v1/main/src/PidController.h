...
#define REVERSE 1
  ...
  void SetOutputLimits(float,
                       float); // clamps the output to a specific range. 0-255
                               // by default, but it's likely the user will want
                               // to change this depending on the application

  // available but not commonly used functions
  // ********************************************************
  void SetTunings(
      float, float, // * While most users will set the tunings once in the
